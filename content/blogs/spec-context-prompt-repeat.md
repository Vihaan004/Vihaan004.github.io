...
date: "2025-10-07"
description: "Exploring the iterative cycle of specification, context engineering, prompting, and refinement in an AI-driven development workflow."
draft: false
---

As of October 8th, 2025, I'm on track to become a proficient natural language programmer. Building random tools by communicating ideas in English has become a self-reflection journey. To compare the programmer I dreamed of five years ago with the programmer I’m shaping into right now. 

GenAI has obviously transformed the software development cycle from *plan-code-debug-deploy* to what I call *spec-context-prompt-repeat*. I find myself caught in this loop so often that I might as well get it printed on a T-shirt. SCPR is essentially how I leverage LLMs to bring random ideas to life consistently. 

The one thing that got me to pursue engineering in the first place was the ability to improve quality of life through cool tech, to transform science and imagination into reality. This pursuit created the productivity nerd I am today, with an urge to maximize efficiency in every automatable repetitive task. Productivity has never been a more valuable deliverable than it is today. Pick a workflow, inject an LLM into it, call it “next-gen,” and voila, you’ve got a startup idea.
...
Still, my doubts haven’t stopped me from accelerating my workflows with AI. Many of the projects I’m currently working on are being built from the ground up using the SCPR cycle. Here’s what I learned so far and how I tackle each stage:

### Spec

This is the toughest stage in the cycle, because it is the most important for the downstream. If you’re relying on an LLM to build upon your vision from scratch, it’s necessary to communicate that vision in the utmost detail. Specifications are no longer static “requirements documents”, they are living, structured expressions of intent. A good spec for agentic workflows isn’t just what you want built; it captures *why* it matters, *how* it aligns with user needs, and *what values* drive its design.
...
Every output from the model is an opportunity for reflection. You loop back, not just to fix syntax errors or progress to the next item, but to refine intent. Each repetition polishes your spec, expands your context, and sharpens your prompting technique.

This “repeat” stage is what makes SCPR *evolutionary* rather than linear. It’s not just debugging; it’s alignment tuning (kind of like instruction tuning). You’re effectively training your personal development system (yourself and the model) through continual iteration. Over time, your specs get cleaner, your context more complete, and your prompts more expressive.
