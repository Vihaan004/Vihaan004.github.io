...
const projectsData = [
  ...
  },
  {
    ...
    description: "An interactive planning tool for students to visualize, plan, and track their academic programs.",
  ...
  {
    id: 8,
    name: "Website - Jainam Patel",
    description: "A web design for Jainam Patel's Architecture Portfolio",
    tags: ["React", "CSS", "JavaScript", "Web Development"],
    link: "https://jainampatel.vercel.app",
    imageUrl: "/project-images/jainam-site.png",
    isFeatured: false
  },
  {
    id: 10,
